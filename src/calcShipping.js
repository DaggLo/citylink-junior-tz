 ...
 *
 * Так как расчет стоимости является простым преобразованием данных,
 * и не предвидится его конвертация в абстракцию с определенным сроком жизни,
 * то не видно необходимости в классах и экземплярах. Код только усложнится и
 * вырастет в объеме.
 */
