 ...
 * Задача:
 *
 * Необходимо описать архитектуру на php из методов или классов для получения
 * стоимости доставки по каждому из указанных перевозчиков согласно данным формулам.
 *
